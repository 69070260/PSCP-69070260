...
```text
โจทย์ให้รับค่า S ที่แทนพื้นที่ที่น้ำหมึกแผ่ขยายไปต่อหนึ่งวินาที และ รับจำนวน N แทนจำนวนคำร้องจากผู้คน

Input:
รับค่า S และค่า N ในบรรทัดเดียวกัน

Output:
ออกมาเป็นเวลาของบ้านแต่ละหลังว่าจะโดนน้ำท่วมในวินาทีที่เท่าใด
```
...
```text
Step 1: รับค่าจำนวนเต็ม X , N
Step 2: ให้เข้า for loop ที่ขึ้นอยู่กับจำนวน N เพราะค่า N คือจำนวนคำร้องของคน
Step 3: รับค่า x , y ของแต่ละบ้าน
Step 4: นำมาคำนวนระยะทางและเวลาที่น้ำจะท่วมบ้าน
Step 5: พิมพ์ คำตอบของแต่ละบ้านออกมาเป็นหน่วยวินาที

ผมไม่รู้วิธีหา ระยะทาง  และ คำนวนเวลา ผมเลยต้องถาม google
```
...
```text
ตามแผนแรกที่เขียนไป แต่อาจจะใช้เวลาเยอะหน่อยและหาในgoogleเยอะมากๆเพราะสูตรมันดูยุ่งยากมากๆ
...
```text
เพราะเป็นทางผ่านแรกที่ต้องผ่านให้ได้ จะได้ไปถูก
```
...
```text
ถ้าเป็น 0 จะต้องไม่พิมพ์อะไรออกมา
```

...
```text
การแปลงอุณหภูมิพวกนี้ต้องใช้ทศนิยมอยู่แล้ว เลยใช้ float แล้วเค้าก็มีสูตรการแปลงหน่วยมาให้อยู่แล้ว

Input:
บรรทัดแรก โปรแกรมรับค่าอุณหภูมิ
บรรทัดสอง รับหน่วยที่เรามีอยู่
บรรทัดสาม รับหน่วยที่เราอยากให้เป็น

Output:
โปรแกรมจะแปลงองศาที่เราต้องการให้ออกมาเป็นค่า float 2 ตำแหน่ง

Constraints:
จริงๆมันเขียนให้สั้นกว่านี้ได้ แต่ผมเขียนไม่เป็น T^T
```
...
```text
Step 1: รับค่า float ที่จะแปลงมา และรับหร่วยที่เรามี และหน่วยที่เราจะแปลงมา
Step 2: ตรวจว่าเป็นหน่วยไหน และจะแปลงเป็นหน่วยไหน
Step 3: ถ้าเข้าหน่วยนั้นๆ ค่อยไปดูอีกทีว่าจะแปลงเป็นหน่วยไหน
Step 4: พิมพ์าิ่งที่คำนวนออกมา
```
...
```text
เหมือนกับแผนแรกที่ผมวางไว้ แต่มันเขียนให้สั้นกว่านี้ได้เยอะเลยแต่ผมทำไม่เป็นครับ T^T เลยเขียนเต็มๆไปเลย
```
...
```text
เพราะต้องเช็คตามโจทย์ก่อนว่ามาถูกทางไหม
```

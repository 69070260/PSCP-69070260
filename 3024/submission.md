...
```text
โจทย์ให้รับค่าคะแนนรวมของคน3คน และรับค่าคะแนนที่สูงสุด และให้หาว่าถ้าคะแนนสูงสุดกับต่ำสุดห่างกัน 2 คะแนนขึ้นไปจะพิมพ์ Surprising ถ้าไม่ให้พิมพ์ Not surprising

Input:
รับค่าคะแนนรวมมา และรับค่าสูงสุดมา

Output:
ถ้าคะแนนสูงสุดกับต่ำสุดห่างกันมากกว่า 2 คะแนน ให้พิมพ์ surprising ถ้าไม่ให้พิมพ์ Not surprising

Constraints:
คะแนนจะไม่มีวันติดลบ ไม่ว่าจะเป็นคะแนนสูงสุดหรือต่ำสุดก็ตาม ผมแก้อยู่ตั้งนาน นานแบบมากๆก็ยังหาไม่เจอ ห้ามลืมเด็ดขาดห้ามติดลบ
```
...
```text
Step 1: รับคะแนนรวมทั้ง3คนมา และรับคะแนนสูงสุดมา
Step 2: คำนวนดูว่า ค่าต่ำที่สุดเท่าที่เป็นไปได้คือเท่าไหร่
Step 3: ถ้าคะแนนสูงสุดและต่ำสุดห่างกันมากกว่า 2 คะแนนให้พิมพ์ surprising
Step 4: ถ้าห่างกันน้อยกว่าหรือเท่ากับ 2 คะแนนให้พิมพ์ Not surprising
```
...
```text
ใช้คล้ายกับแผนแรก แต่แผนแรกผมอะลืมว่าคะแนนห้ามติดลบ ผมหาอยู่ตั้งนานว่าทำไมผิด Test case เดียวตั้งนาน จนทนไม่ไหวเลยลองถาม AI ดูว่าผิดตรงไหน ผิดแค่ 1 Test case จนมันบอกว่า คะแนนต่ำสุดไม่มีวันติดลบ ถ้าติดลบให้คะแนนต่ำสุดนั้นเท่ากับ 0 ไปเลย T^T
```
...
```text
ลองดูว่ามันเหมือนกับในโจทย์มั้ย จะได้รู้ว่ามาถูกทางรึป่าว
```
...
```text
อันนี้ก็เหมือนกัน หาสิ่งที่มันได้ Surprising ในโจทย์
```
...
```text
เพราะถ้าค่าต่ำสุดติดลบ มันจะเป็นยังไง
```

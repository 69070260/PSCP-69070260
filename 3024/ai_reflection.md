...
| OJ submission ID, if submitted | 588136 |
| OJ status | Pass |
...
```text
ผมถามว่าผมผิดตรงไหนทำไมผิดอยู่ 1 test case ทั้งๆที่ผมก็ทำทุกๆวิธีทางแล้ว
```
...
```text
AI ช่วยบอกว่า คะแนนต่ำสุด หรือคะแนนใดๆก็ตามจะไม่มีวันติดลบ
```
...
```text
ผมไปแก้ไม่ให้ตัวแปร low ที่เป็นค่าต่ำสุดติดลบ ถ้าติดลบให้มันเป็น 0 ไปเลย
```
...
```text
ผมได้รู้ว่า คะแนนห้ามติดลบ ไม่ว่าจะเป็นค่าติดลบ หรือค่าสูงสุดก็ตาม ควรจะเช็คในหลายๆแบบ
```

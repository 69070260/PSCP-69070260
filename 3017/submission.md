...
```text
โจทย์ให้คำนวนค่าอาหารที่รวมทั้ง อาหาร SERVICE VAT

Input:
เค้าให้เราใส่ราคาอาหารทั้งหมดที่สั่งเข้าไป

Output:
output ควรออกมาโดย ราคาอาหาร + ค่าบริการ + VAT

Constraints:
อย่าลืมอ่านโจทย์ดีๆเพราะ ตอนคำนวน VAT เค้าให้เอา อาหาร+กับค่าบริการก่อนแล้วค่อยเอาไปหา VAT นั่งหาจุดผิดตั้งนาน
```
...
```text
Step 1: รับ input ค่าอาหารมา
Step 2: ในโจทย์ค่าบริการขั้นต่ำคือ 50 บาท และมากสุดคือ 1000 บาท ซึ่งจะคิดเป็น 10% ของค่าอาหารของเรา
Step 3: แบ่ง if else ของ ค่าบริการ
Step 4: พอได้ค่าบริการมาแล้ว เราก็เอาไปคำนวน vat ได้ เพราะ vat คำนวนจากค่าบริการของเราด้วย
Step 5: คำนวนค่าอาหารทั้งหมดเอา ค่าอาหาร + ค่าบริการ + vat
```
...
```text
วิธีสุดท้ายไม่คล้ายวิธีแรกเท่าไหร่ วิธีแรกของผมมันเป็นคำนวนโดยการแยกคำนวนหลายกรณีเกินมันมั่วเกินไป เลยนั่งลบและทำวิธีสุดท้าย คือการทำ if else ของค่าบริการแยกไปเลยง่ายกว่าเยอะ แล้วเอามาคำนวนชิวๆ
```
...
```text
เพราะมันเป็น case แรกของงานนี้เลยอยากทดสอบดูว่าเหมือนจริงหรือไม่
```
...
```text
เพราะมันเป็น case ที่สองของงานนี้เลยอยากทดสอบดูว่าเหมือนจริงหรือไม่
```
...
```text
เพราะมันเป็น case สุดท้ายของงานนี้เลยอยากทดสอบดูว่าเหมือนจริงหรือไม่
```

...
```text
Input:
เค้าให้รับตัวอีกษรมา5ตัว

Output:
เค้าให้แสดงผลออกมาเป็นตัวเล็กทั้งหมดและต้องสลับตัวอักษรด้วย

Constraints:
อย่าลืมเขียนวงเล็บครอบตัวแปร name เพื่อที่จะสลับออกมาแล้วจะต้องเป็นตัวเล็กทั้งหมดด้วย
```
...
```text
Step 1:  ผมคิดในหัวก่อนว่าต้องรับค่า name มาก่อน
Step2:  ผมต้องเขียน print ค่า name และใช้คำสั่ง index เพื่อสลับตัวอักษรแล้วครอบด้วยวงเล็บเพื่อเขียน .lower ให้ค่าที่รับมาทั้งหมดนั้นเป็นตัวเล็กทั้งหมดครับ
```
...
```text
เหมือนแผนแรก ผมคิดออกมาได้ประมาณนี้แล้วค่อยๆแตกเป็นย่อยๆ ว่าถ้ารับค่ามาแล้วควรทำไงต่อ ทำให้ตัวอักษรสลับกันและต้องเป็นตัวพิมพ์เล็กหลังรับค่ามาแล้ว
```
...
```text
เพราะมันเป็นชื่อที่มีตัวพิมพ์ใหญ่และพิมพ์เล็กในชื่อเดียวกัน
```
...
```text
เพราะมันมีตัวใหญ่ทั้งหมดเราต้องทำให้เป็นตัวเล็กทั้งหมด
```
...
```text
เพราะมีทั้งตัวเลขและตัวพิมพ์ใหญ่และเล็กในคำเดียวกัน
```

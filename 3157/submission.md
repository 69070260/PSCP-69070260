...
```text
Input:
รับ input มาว่าจะเพิ่มกี่ค่าหรือลดกี่ค่าและสร้างตัวแปลชื่อ count เพื่อเก็บค่าไว้
พิมพ์ว่าจะ + หรือ -
output:
ค่าออกมาเป็นจำนวนที่คำนวณแล้ว
```
...
```text
Step 1: รับค่า x และพิมพ์ตัวอักษรว่าจะเพิ่มหรือลด
Step 2: ถ้า + ให้เพิ่ม 5 ถ้า - ให้ลด 5
Step 3: แสดงค่า output

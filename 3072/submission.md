...
```text
Input:
รับข้อความมา 1 ข้อความ

Output:
โปรแกรมจะพิมพ์ว่าในข้อความนั้นมีสระแต่ละตัวกี่ครั้ง
```
...
```text
Step 1: รับข้อความเข้ามา 
Step 2: สร้าง Array เก็บสระ a e i o u และจำนวนของแต่ละสระ 
Step 3: วนดูตัวอักษรทีละตัว แล้วนับว่ามีสระตัวไหนบ้าง 
Step 4: แสดงสระที่เจอพร้อมจำนวนที่นับได้
```
...
```text
ลองว่านับแบบไม่มีตัวเล็กได้ไหม
```

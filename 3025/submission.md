...
```text
โจทย์ให้รับค่าเดือนมาและวัน ถ้าเดือนที่ 3 6 9 12 และวันที่ 21 ขึ้นไป จะต้องขึ้นฤดูใหม่
...
Constraints:
โค้ดที่ผมพิมพ์ลงไปมันจะมีช่องว่างระหว่างเดือนที่ 2 และเดือนที่ 3 ซึ่งต้องระวังให้ดี เพราะผมนั่งแก้อยู่นานมากๆ
```
...
```text
Step 1: รับค่า int ที่เป็นเดือนกับวัน
Step 2: ตรวจว่าเป็นเดือนไหนและวันไหน ถ้าเดือน 3 ตั้งแต่วันที่ 20 ลงมา ก็พิมพ์ "winter" 
Step 3: ถ้าไม่ใช่ ก็พิมพ์ "spring"
```
...
```text
คล้ายๆกับที่ใช้ครั้งที่แล้ว แค่แตกออกมาเป็นย่อยๆจนครบทุกเดือนและทุกวัน (ผมใช้เวลาไปเยอะมากๆกว่าจะทำเสร็จครับเพราะมันมีช่องว่างระหว่างเดือนและวันที่ผมลืมเขียนลงไปด้วย)
```
...
```text
เพราะต้องตรวจ testcase ธรรมดาก่อน
```
...
```text
เพราะต้องการแก้ไขข้อมูลที่มีช่องว่างระหว่างเดือนและวัน
```
...
```text
เพราะต้องการตรวจดูว่ามันขึ้นเดือนใหม่ให้ไหม
```

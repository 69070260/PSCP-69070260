...
```text
Input:
บรรทัดแรกรับค่า a คือจำนวนอิฐเล็ก
บรรทัด2รับค่า b คือจำนวนอิฐใหญ่
บรรทัด3รับค่า goal คือความยาวสะพานที่ต้องการ

Output:
บอกว่า ต้องใช้อิฐเล็กกี่ก้อน ถ้าสร้างให้พอดีไม่ได้ ให้ตอบ -1
```
...
```text
บอกว่า ต้องใช้อิฐเล็กกี่ก้อน ถ้าสร้างให้พอดีไม่ได้ ให้ตอบ -1
Step 1: อ่านจำนวนอิฐเล็ก a อิฐใหญ่ b และความยาวสะพาน goal
Step 2: หาอิฐใหญ่ที่ใช้ได้มากที่สุดก่อน
Step 3: คำนวณความยาวที่เหลือ แล้วตรวจว่าอิฐเล็กพอหรือไม่
Step 4: ถ้าพอ ให้พิมพ์จำนวนอิฐเล็กที่ใช้ ถ้าไม่พอให้พิมพ์ -1
```

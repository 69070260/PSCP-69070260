...
```text
Input:
รับสถานะสมาชิก Y หรือ N จากนั้นรับจำนวนรายการสินค้า และรับราคาสินค้าแต่ละรายการ

Output:
แสดงยอดเงินสุทธิหลังหักส่วนลด โดยแสดงทศนิยม 2 ตำแหน่ง
```
...
Step 2: รับราคาสินค้าแล้วรวมยอดทั้งหมด
Step 3: ถ้าเป็นสมาชิก ลด 5% ถ้าไม่เป็นสมาชิกและยอดถึง 500 ลด 3%
Step 4: แสดงยอดสุทธิ 2 ตำแหน่ง
```

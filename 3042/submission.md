...
```text
โจทย์ให้รับค่ามา N และตั้งแต่ 0 จนถึง N ให้หาว่า หาร 10 แล้วมีเลขไหนหารลงตัวบ้าง

Input:
รับค่า N ที่เป็นจำนวนเต็มบวกมา แล้วให้เอาไปหาร10แล้วมีตัวไหนได้เศษ0ไหม

Output:
โปรแกรมควรพิมพ์ตัวที่หาร10แล้วได้เศษ0 ออกมาในบรรทัดเดียวกัน

Constraints:
ทำให้ Output ออกมาในบรรทัดเดียวกันยังไม่เป็นต้องไปเสิช google ก่อน
```
...
```text
Step 1: รับค่า N
Step 2: ตรวจว่าตั้งแต่ค่า 0 จนถึง N ตัวไหนหาร 10 แล้วได้เศษ 0 บ้าง
Step 3: พิมพ์ output ออกมาให้อยู่ในบรรทัดเดียวกัน

ก่อนจะเสร็จผมไม่รู้วิธีว่าจะให้ output ออกมาอยู่ในบรรทัดเดียวกันยังไง ต้องไปหาข้อมูลเพิ่มเติม
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก ผมไปหาข้อมูลมาแล้วว่า ให้ใช้ end= เพราะเวลาพิมพ์ print มันจะขึ้นบรรทัดใหม่ให้อยู่แล้วประมาณแบบ \n แต่แค่มันไม่ได้เขียนให้ เราเลยต้อง end=" " ในดับเบิลโคดจะเป็นอะไรก็ได้แล้วมันจะพิมพ์ต่อด้วยตัวที่อยู่ในดับเบิลโคด
```
...
```text
ลองดูว่าถ้ามี 0 ด้านหน้าจะเป็นยังไง
```

...
```text
Input: รับต้นทางกับปลายทาง แล้วรับน้ำหนักพัสดุที่ต้องการส่ง 
Output: แสดงค่าธรรมเนียมการส่งพัสดุ ถ้าเส้นทางไม่มีในตารางให้แสดง Error
```
...
```text
Step 1: รับต้นทาง ปลายทาง และน้ำหนักพัสดุ
Step 2: เช็กว่าเส้นทางตรงกับในตารางหรือไม่
Step 3: ถ้าตรง ให้คำนวณค่าธรรมเนียมแล้วแสดงผล
Step 4: ถ้าไม่ตรง ให้แสดง Error
```
...
```text
เลือกเส้นทางที่มีในตาราง และใช้น้ำหนักเป็นจำนวนเต็ม เพื่อทดสอบการคำนวณปกติ
```
...
```text
ลองดูว่าทศนิยม 2 ตำแหน่งนั้นถูกต้องไหม
```
